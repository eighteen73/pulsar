...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((options = {}) => ({
  ...
  onPointerLeave(menuItemID, parentID) {
    ...
    const mouseWithin = document.querySelector(`#menu-item-${menuItemID}`).matches(':hover');
  ...
  isSubMenuOpen(menuID) {
    return this.openSubMenus.some(openMenuItem => openMenuItem.id === menuID);
  },
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('menu', _components_menu__WEBPACK_IMPORTED_MODULE_1__["default"]);
