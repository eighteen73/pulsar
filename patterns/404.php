...
<main class="wp-block-group site-main">
	...
	<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--5-xl);padding-bottom:var(--wp--preset--spacing--5-xl)">
		...
		<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( '404: Nothing Found', 'pulsar' ); ?></h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","className":""} -->
		<p class="has-text-align-center"><?php esc_html_e( 'It looks like you stumbled upon a page that does not exist.', 'pulsar' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</main>
